scriptTitle = "DNServ Repo Browser"
scriptAuthor = "DNServ"
scriptVersion = 2
scriptDescription = "The DNServ script repository browser, Download and install DNServ Utility Scripts"
scriptIcon = "icon.png"
...
function CheckUpdate()
	...
	if url ~= "" then
		...
		if http.Success then
			...
			Script.SetProgress(50);
			local ini = IniFile.LoadString(http.OutputData);
			local section = ini:GetSection("DNServRepo");
